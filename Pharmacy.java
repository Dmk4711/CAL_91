...
private void MedicineTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MedicineTableMouseClicked
    ...
    dpFabDate.update((Date)model.getValueAt(myIndex, 3));
    dpExpDate.update((Date)model.getValueAt(myIndex, 4));
...
private JDateChooser dpExpDate;
private Component dpFabDate;
